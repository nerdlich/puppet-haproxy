define haproxy::backend ($order = 30, $port = '80', $mode = 'http', $balance = 'roundrobin', 
						$servers = '', $options = [], $hash_type = 'manual', $query = '',
						$server_maxconn = '', $cookie = false, $cookie_name = '', $cookie_options = '',
						$server_check = false, $check_inter = '', $check_fall = '', $appsession = false) {
	# Some validations
	case $hash_type {
		'manual': {
